...
const localStorageComentarios = JSON.parse(localStorage.getItem("localStorageComentarios")
  );
...
function guardarAlLocalStorage(listaComentarios) {
  window.localStorage.setItem("localStorageComentarios",JSON.stringify(listaComentarios));
  window.localStorage.setItem("localStorageComentarios",JSON.stringify(listaComentarios2));
}

window.addEventListener("storage", (e) => {
  listaComentarios = JSON.parse(localStorage.getItem("localStorageComentarios"));
  const p = document.createElement("p");
